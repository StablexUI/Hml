...
::String CallStack_obj::toString( Array< ::Dynamic > stack){
	HX_STACK_FRAME("haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","/usr/lib/haxe/std/haxe/CallStack.hx",206,0xab2662dc)
...
{
		HX_STACK_FRAME("haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","/usr/lib/haxe/std/haxe/CallStack.hx",216,0xab2662dc)
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(216)
