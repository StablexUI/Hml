...
::String Fast_obj::get_name( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_name",0x9611daa7,"haxe.xml.Fast.get_name","/usr/lib/haxe/std/haxe/xml/Fast.hx",133,0xd31baf82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
::String Fast_obj::get_innerHTML( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_innerHTML",0x2484dc25,"haxe.xml.Fast.get_innerHTML","/usr/lib/haxe/std/haxe/xml/Fast.hx",157,0xd31baf82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(158)
