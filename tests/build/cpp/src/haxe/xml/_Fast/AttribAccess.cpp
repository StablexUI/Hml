...
bool AttribAccess_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void AttribAccess_obj::__register()
{
	...
	__mClass->mSetStaticField = &AttribAccess_obj::__SetStatic;
