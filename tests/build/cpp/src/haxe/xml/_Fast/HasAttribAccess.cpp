...
bool HasAttribAccess_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void HasAttribAccess_obj::__register()
{
	...
	__mClass->mSetStaticField = &HasAttribAccess_obj::__SetStatic;
