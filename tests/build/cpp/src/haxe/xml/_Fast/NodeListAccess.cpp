...
bool NodeListAccess_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void NodeListAccess_obj::__register()
{
	...
	__mClass->mSetStaticField = &NodeListAccess_obj::__SetStatic;
