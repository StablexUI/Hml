...
public class ListIterator<T> extends haxe.lang.HxObject
{
	...
	public static <T_c> void __hx_ctor__List_ListIterator(_List.ListIterator<T_c> __temp_me15, haxe.root.Array head)
	{
		//line 245 "/usr/lib/haxe/std/List.hx"
		__temp_me15.head = head;
		//line 246 "/usr/lib/haxe/std/List.hx"
		__temp_me15.val = null;
	}
