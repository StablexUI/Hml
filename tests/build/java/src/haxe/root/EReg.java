...
public class EReg extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor__EReg(haxe.root.EReg __temp_me10, java.lang.String r, java.lang.String opt)
	{
		...
		__temp_me10.matcher = java.util.regex.Pattern.compile(haxe.lang.Runtime.toString(haxe.root.EReg.convert(r)), ((int) (flags) )).matcher(((java.lang.CharSequence) ("") ));
		//line 49 "/usr/lib/haxe/std/java/_std/EReg.hx"
		__temp_me10.pattern = r;
	}
