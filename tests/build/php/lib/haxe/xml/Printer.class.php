...
class haxe_xml_Printer {
	public function __construct($pretty) {
		...
		$GLOBALS['%s']->push("haxe.xml.Printer::new");
	...
	public function writeNode($value, $tabs) {
		$GLOBALS['%s']->push("haxe.xml.Printer::writeNode");
		$__hx__spos = $GLOBALS['%s']->length;
		$_g = $value->nodeType;
		switch($_g) {
		case 2:{
	...
	public function hasChildren($value) {
		$GLOBALS['%s']->push("haxe.xml.Printer::hasChildren");
		$__hx__spos = $GLOBALS['%s']->length;
	...
	static function hprint($xml, $pretty = null) {
		$GLOBALS['%s']->push("haxe.xml.Printer::print");
		$__hx__spos = $GLOBALS['%s']->length;
		if($pretty === null) {
			$pretty = false;
		}
